...
const errors = {
  ...
  descricao_da_foto: "Descreva a fotografia no campo de texto alternativo.",
  invalid_image_path: "O caminho da fotografia precisa começar com / e terminar em .jpg, .png, .webp ou .avif.",
  image_alt_required: "Descreva a fotografia no campo de texto alternativo.",
